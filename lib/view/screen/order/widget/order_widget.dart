...
class OrderWidget extends StatelessWidget {
          ...
          InkWell(
            ...
            child: Container(
              decoration: BoxDecoration(
                  color: orderModel.otherdetails!.type=="delivery"?ColorResources.CARD_DELIVERY:ColorResources.CARD_PICKUP,
                      ...
                      children: [
                          ...
                          child: InkWell(
                            ...
                            child: Row(
                              children: [
                                ...
                                Text("${orderModel.refId!.substring(orderModel.refId!.length - 3)}",
                        ...
                        Container(
                          ...
                          child: Padding(
                            ...
                            child: Text("${orderModel.otherdetails!.type!.toUpperCase()}  | \$ ${orderModel.otherdetails!.grandTotal}",
                              style: TextStyle(fontWeight: FontWeight.w700, fontSize: 20.0,color: Colors.brown),),
                          ),),
                      ],
                    ),
                  ),
                            ...
                            children: [
                              ...
                              Row(
                                ...
                                children: [
                                  Text("Order Time:",
                                      style: robotoRegular.copyWith(color: Colors.black)),
                                  Text("${getFormatTime(orderModel.otherdetails!.checkOutDateTime)}",
                                      style: robotoBold.copyWith(color: Colors.black)),
                                ],
                              ),
                              orderModel.otherdetails!.type  != "delivery" ? SizedBox(height: 12,):SizedBox(height: 0,),
                              orderModel.otherdetails!.type  != "delivery" ?Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Pick-up Time:",
                                      style: robotoRegular.copyWith(color: Colors.black)),
                                  Text("${orderModel.otherdetails!.customer_status} Minute",
                                      style: robotoBold.copyWith(color: Colors.black)),
                                ],
                              ):Container(),
                              SizedBox(height: 12,),
                              ...
                              Row(
                                ...
                                children: [
                                  Text("Phone Number:",
                                      style: robotoRegular.copyWith(color: Colors.black)),
                                  Text("${orderModel.otherdetails!.userPhone}",
                                      style: robotoRegular.copyWith(color: Colors.black)),
                                ],
                              ),

                              orderModel.otherdetails!.type  == "delivery" ? SizedBox(height: 0,):SizedBox(height: 12,),
                              Row(
                                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                children: [
                                  Text("Address:",
                                  ...
                                  Row(
                                    children: [
                                      orderModel.otherdetails!.type  == "delivery" ? InkWell(
                                        onTap: () => navigateTo(orderModel),
                                        child: Container(
                                          // decoration: BoxDecoration(
                                          //     color: Theme.of(context).primaryColor,
                                          //     borderRadius: BorderRadius.circular(50)
                                          ...
                                          child: Padding(
                                            ...
                                            child: Container(height: 34, width: 34,
                                              ...
                                              child: Image.asset(
                                              Images.current_location_select
                                              ),),
                                          ),
                                        ),
                                      ):Container(),
                                      orderModel.otherdetails!.type  == "delivery" ? InkWell(
                                        onTap: () => navigateTo(orderModel),
                                        child: Text("${orderModel.otherdetails!.address}",
                                            style: robotoRegular.copyWith(color: Colors.black)),
                                      ):
                                      Text("${orderModel.otherdetails!.address}",
                                        style: robotoRegular.copyWith(color: Colors.black)),
                                      //SizedBox(width: 10,),
                              ...
                              Row(
                                ...
                                children: [
                                  Text("Pay by:",
                                      style: robotoRegular.copyWith(color: Colors.black)),
                                  Text("${orderModel.otherdetails!.paymentOpt}",
                                      style: TextStyle(
                                          color: Colors.brown,
                                          fontWeight: FontWeight.bold,
                                          fontFamily: robotoRegular.fontFamily
                                      )
                                  ),
                                ],
                              )
                      ...
                      Row(mainAxisAlignment:MainAxisAlignment.spaceBetween,
                        crossAxisAlignment: CrossAxisAlignment.center, children: [
                          ...
                          Row(children: [
                            ...
                            orderModel.status  == 1 || orderModel.status  == -1 ?InkWell(
                            ...
                            StatusCheck.btnCancel(orderModel.status)?SizedBox(width: 8,):SizedBox(width: 0,),
  ...
  void navigateTo(Order order) async {
    ...
    var uri =Uri.parse( 'https://www.google.com/maps/search/?api=1&query=${order.otherdetails!.ulat},${order.otherdetails!.ulong}');
