...
class OrderCooking extends StatefulWidget {
  const OrderCooking({Key? key}) : super(key: key);

  @override
  State<OrderCooking> createState() => _OrderCookingState();
}

class _OrderCookingState extends State<OrderCooking> {
  ...
  _buildListAll() {
    ...
    var check_query_pending = context.watch<ParseProvider>().getQueryBuilderAccepted??null;
    print("---------cooking");
    print("---------ob");

    return check_query_pending == null? Container(child: Center(child: Text(AppStrings.authentication_issues),),): Container(
      height: MediaQuery.of(context).size.height,
      width: MediaQuery.of(context).size.width,
      child: ParseLiveListWidget<ParseObject>(
          query: context.watch<ParseProvider>().getQueryBuilderAccepted!,
          //key:refreshKey,
